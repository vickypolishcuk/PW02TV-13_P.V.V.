...
import com.example.test1.databinding.FragmentThirdBinding
...
class ThirdFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.sumButton.setOnClickListener {
            ...
            val result1 = (10.0.pow(6) / num5)  * 1  * (num7 / (100 - 0)) * (1 - 0.985)
            val result2 = 10.0.pow(-6) * result1 * num5 * num9


            // Відображення результатів
            binding.res1.text = getString(R.string.result_text_maz1, result1)
            binding.res2.text = getString(R.string.result_text_maz2, result2)
        }
